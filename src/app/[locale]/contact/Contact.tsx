...
import { NavBar, HeroHeader, Bottom, Footer, HubSpotForm, FadeInSection } from '@/components/components';
...
const Contact: React.FC<IContact> = ({ locale }) => {
	...
	return (
		<div className="max-w-[100vw] overflow-hidden dark:bg-gray-800">
			...
			<FadeInSection>
			<div className={`w-[90vw] lg:w-3/6 mx-auto ${locale == "en" ? "-translate-y-[45vh]" : "-translate-y-[35vh]"} z-20 relative`}>
