		...
		<div className="max-w-[100vw] overflow-hidden dark:bg-gray-800">
			...
			<FadeInSection>
				<Card 
					...
					imgUrl="/Revoluspace_Scheduling.mp4"
			...
			<FadeInSection>
				<Card 
					...
					direction="reverse"
					imgUrl="/Revoluspace_DeskBooking.mp4"
					IntegrationButtonText={t('about')}
					IntegrationButtonLink={{ slack: `/${locale}/slack`, msteams: `/${locale}/msteams` }}
					gif
				/>
			...
			<div className="w-5/6 py-[10vh] mt-[15vh] mx-auto flex flex-col gap-y-[15vh]">
				<FadeInSection>
					<p className="text-3xl lg:text-5xl text-center font-semibold w-9/12 mx-auto">{t('smartofficesolution.title')}<span className='purple-gradient'>{t('smartofficesolution.enhance')}</span></p>
				</FadeInSection>
			...
			<div className='w-5/6 lg:w-[90vw] mx-auto flex flex-col gap-y-[15vh] mt-[15vh]'>
				...
				<div className='w-full lg:gap-x-8 lg:w-[80vw] mx-auto flex justify-between flex-col lg:flex-row items-center lg:items-start gap-y-16'>
					<div className="flex flex-grow flex-col justify-between leading-norma w-full lg:w-[35vw] h-fit gap-y-6">
						<p className="mb-2 text-2xl lg:text-4xl font-semibold text-gray-900 dark:text-brand-white first-letter:capitalize">{t('TrustRevoluspace.tagline.title')}<span className='purple-gradient'>{t('TrustRevoluspace.tagline.enhance')}</span></p>
